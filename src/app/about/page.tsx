export default function About() {
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>About Me</h1>
      <p>
        Hi! I'm <strong>Usama</strong>, a third-year MBBS student who has decided to explore the fascinating world of technology and software development. Although I initially set out to become a doctor, my passion for AI, machine learning, and technological advancements in medicine led me to pivot towards becoming a software developer.
      </p>
      <p>
        Currently, I'm focusing on learning and building projects in areas such as:
      </p>
      <ul>
